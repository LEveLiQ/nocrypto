...
You must respond in strict JSON format matching this exact schema:
{
  ...
  configFieldScamProbabilityThreshold: "Scam Probability Threshold",
  ...
  configFieldExcludedUrls: "Excluded URLs",
  configFieldLanguage: "Language",
  configFieldScanMemberAgeThreshold: "Scan Member Age",
  ...
  configDescTargeting: "**🎯 Targeting Settings** — Limit scanning to recently joined members to optimize API quota usage.",
  ...
  configBtnEditUrls: "Edit URL Filters",
  configBtnTargeting: "Targeting",
  ...
  configSelectScanMemberAgeThreshold: "Select member age threshold...",
  ...
  configValScanMemberAgeAll: "Scan All Members (Default)",
  configValScanMemberAge1w: "Joined < 1 Week Ago",
  configValScanMemberAge1m: "Joined < 1 Month Ago",
  configValScanMemberAge6m: "Joined < 6 Months Ago",
  ...
  // Modal
  modalThresholdTitle: "Set Scam Probability Threshold",
  ...
  modalUrlsTitle: "Edit Excluded URLs",
  modalUrlsLabel: "URLs/Domains (one per line)",
  modalUrlsPlaceholder: "e.g. google.com\ntrusted.com",
  ...
  onboardStep1Value: "Use `/config` to open the interactive settings panel and set a private admin channel where I will log detailed scam alerts, scam probability ratings, and actions taken.",
  onboardStep2Title: "⚙️ 2. Review Your Settings",
  onboardStep2Value: "The `/config` panel shows your full configuration at a glance. Default settings scan both links and images with a 70% scam probability threshold.",
  ...
  logFieldScamProbability: "Scam Probability",
