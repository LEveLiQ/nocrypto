...
다음의 정확한 JSON 형식으로 응답해야 합니다:
{
  ...
  configFieldScamProbabilityThreshold: "스캠 확률 기준치",
  ...
  configBtnThreshold: "스캠 확률 기준치: %s%",
  ...
  // 모달
  modalThresholdTitle: "스캠 확률 기준치 설정",
  modalThresholdLabel: "스캠 확률 기준치 (50 – 100)",
  ...
  onboardStep1Value: "`/config` 명령어로 설정 패널을 열고, 상세한 스팸 알림, 스팸 기준치, 조치 내역이 기록될 비공개 관리 채널을 설정하세요.",
  onboardStep2Title: "⚙️ 2. 설정 확인",
  onboardStep2Value: "`/config` 패널에서 전체 설정을 한눈에 확인할 수 있습니다. 기본 설정은 링크와 이미지를 모두 감지하며 70% 스팸 기준치를 사용합니다.",
  ...
  logFieldChannels: "채널",
  logFieldScamProbability: "스팸일 확률",
  logFieldStatus: "상태",
  ...
  reportScamDetected: "⚠️ **스팸 감지!**\n**%s** 님의 메시지가 **%s%%** 확률로 스팸으로 판정되어 자동으로 삭제되었습니다.%s\n\n**사유:** *%s*",
